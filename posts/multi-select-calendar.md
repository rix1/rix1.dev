...
lets you select multiple days while staying somewhat accessible.

---

### Motivation

I'm building a simple service for my (rather large) family to coordinate
different things (dinner, cabin trips etc). I needed a calendar to select date
ranges to make it easy to answer the following:
...
[@rix1 on Twitter](https://twitter.com/rix1).
